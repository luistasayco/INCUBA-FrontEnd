...
@Component({
  selector: 'app-vacunacion-spray-create-offline',
  templateUrl: './vacunacion-spray-create-offline.component.html',
  styleUrls: ['./vacunacion-spray-create-offline.component.css']
})
export class VacunacionSprayCreateOfflineComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.subscription$ = this.vacunacionSprayLocalService.getTxVacunacionSprayNew()
  ...
  getToObtieneBoquilla() {
    ...
    this.subscription$ = new Subscription();
    this.subscription$ = this.vacunacionSprayLocalService.getBoquilla()
  ...
  getToObtieneProceso() {
    ...
    this.subscription$ = new Subscription();
    this.subscription$ = this.vacunacionSprayLocalService.getProcesoSpray()
