...
@Component({
  selector: 'app-tx-sim-create',
  templateUrl: './tx-sim-create.component.html',
  styleUrls: ['./tx-sim-create.component.css']
})
export class TxSimCreateComponent implements OnInit, OnDestroy {
